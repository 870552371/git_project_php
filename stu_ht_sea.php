...
<head>
    ...
    <script type="text/javascript" src="A_public/js/jquery-3.2.1.js"></script>
...
<div id="container">
<?php
include_once("A_public/code/permission/permission_flag.php");
include_once("A_public/module/head/head.php");
include_once("A_public/module/link/link.php");
include_once("stu_ht_sea/stu_ht_sea_c.php");
